package com.lazycoder.quickaid.DashBoard;
        ...
        authListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user == null){
                    ...
                    startActivity(new Intent(DashBoard.this, RegistrationActivity.class));
                    finish();
                }
            }
        };
                            ...
                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if (task.isSuccessful()){
                                        Toast.makeText(DashBoard.this, "Email address is updated. Please sign in with new email id!", Toast.LENGTH_SHORT).show();
                                        signOut();
                                        ...
                                        Toast.makeText(DashBoard.this, "Failed to Update.Please try again!", Toast.LENGTH_SHORT).show();
                                        progressBar.setVisibility(View.GONE);
                                    }
                                }
                            });
